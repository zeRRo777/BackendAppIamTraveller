                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th>Имя</th>
                                        <th>Почта</th>
                                        <th class="text-center">Количество достопримичательностей</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$user->username}}</td>
                                            <td>{{$user->email}}</td>
                                            <td class="text-center">{{$user->count_attractions}}</td>
                                            <td class="text-center">{{$user->scores}}</td>
                                            <td class="text-center"><a href="{{route('admin.users.show', $user->id)}}">
