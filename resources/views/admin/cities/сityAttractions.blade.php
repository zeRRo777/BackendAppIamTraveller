            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h2 class="m-0">Город: {{$city->name}}</h2>
                        <h2 class="m-0">Страна: {{$city->country}}</h2>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2 mb-3">
                        <a href="{{route('admin.cities.city_attractions_create', $city->id)}}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('admin.attractions.show', $attraction->id)}}">
                                                    <i class="far fa-sharp fa-solid fa-eye"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
